...
books = [ # Sample data for the API (list of dictionaries)
    {'id': 0,
...
@app.route('/api/v1/resources/books/all', methods=['GET']) # Define the route for the API endpoint
def api_all():
    return jsonify(books)

@app.route('/api/v1/resources/books', methods=['GET']) # Define the route for the API endpoint with query parameters
def api_id():
